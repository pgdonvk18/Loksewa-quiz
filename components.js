// Global Components (Chat, Footer, & Other Pages Header)
(function() {
  ...
  // Inject HTML structure (Header ONLY for non-dashboard pages, Chat & Footer for all pages)
  ...
  if (document.body) {
    // If it is NOT dashboard.html, insert the header at the very top
    if (isNotDashboard) {
      const headerDiv = document.createElement('div');
      headerDiv.innerHTML = `
        <header class="screenshot-dashboard-header">
          <button class="dash-header-icon-btn" onclick="openMenuDrawer()" title="Menu"><i class="fa-solid fa-bars"></i></button>
          <div class="dash-header-title">LoksewaQuest</div>
          <button class="dash-header-icon-btn" onclick="openNotifications()" title="Notifications"><i class="fa-solid fa-bell"></i></button>
        </header>
      `;
  ...
  window.openMenuDrawer = function() {
    alert("मेनु (Menu) बटन क्लिक भयो!");
  };

  window.openNotifications = function() {
    alert("नोटिफिकेसन (Notifications) बटन क्लिक भयो!");
  };
